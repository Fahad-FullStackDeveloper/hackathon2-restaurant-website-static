  ...
  return (
    <>
      <div className="relative bg-base inset-0 mt-10">
        {/* Background image applied directly to the container */}
        <div 
          className="max-w-screen bg-cover bg-center" 
          style={{ backgroundImage: "url('/images/BG_RestaurantActiveProcess.png')" }}
        >
          <div className="container px-10 relative z-10 flex flex-col items-end h-full text-right">
            <div className=" p-8 rounded-lg max-w-2xl">
              ...
              <h3 className="text-4xl md:text-5xl font-semibold text-white mb-6">
                <span className="text-brand">We</span> Document Every Food Bean Process until it is saved
              </h3>
              <p className="text-lg text-white mb-6">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Illum et
                minima saepe dolorum consequatur sunt dicta ab provident, assumenda
                at quas deserunt omnis voluptates praesentium.
              </p>
